...
class ProducerExampleCommand extends Command
{
    private const TOPIC = 'topic';

    protected static $defaultName = 'kafka:example:producer';
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        for ($i = 1; $i <= 20; ++$i) {
            $topic->produce(\RD_KAFKA_PARTITION_UA, 0, '{"content":"Message payload '.$i.'"}');
            $producer->poll(0);
        }
